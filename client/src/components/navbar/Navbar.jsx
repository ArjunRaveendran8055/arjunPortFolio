...
const Navbar = ({ heroRef, skillRef, projectRef, footerRef }) => {
  ...
  return (
    ...
    items-center text-lg ${
      y <= 850 ? "text-white" : " text-darkblue"
      ...
      >
        ...
        <div className="nav-items-container hidden lg:flex lg: gap-40 font-bold">
          ...
          <div className="cursor-pointer">
            <div
              className="hover:scale-150 transition duration-200"
              onClick={() => ScrollHandler(footerRef)}
            >
              ContactMe
            </div>
          </div>
        ...
        <div className="lg:hidden basis-4/5 flex h-full justify-end items-center ml-2">
          ...
          />
          {toggle ? (
            <div className="absolute w-4/5 h-[100vh] top-0 right-0  bg-difblue flex flex-col gap-8 text-violet text-3xl items-center font-Playfiar-600 pt-[20px]">
