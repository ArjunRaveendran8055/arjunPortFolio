  ...
  return (
    <section ref={projectRef} className="project-section mt-2">
      <div className="bg-black w-full flex flex-col lg:px-20 lg:py-14 sm:p-2">
        <motion.div
          className="project-title bg-black w-full h-10 lg:p-12 flex flex-row justify-center items-center"
        ...
        >
          <div className="text-3xl text-white font-enriq">
            <p className="underline underline-offset-[15px] bg-clip-text decoration-orange decoration-4">
              PRO <span className="text-orange">JECTS</span>
            </p>
          </div>
        </motion.div>
        <motion.div
